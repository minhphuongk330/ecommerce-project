...
const Header: React.FC = () => {
  ...
  // --- 1. BIẾN QUAN TRỌNG NHẤT ĐỂ SỬA LỖI ---
  ...
  // Gọi trực tiếp Store (Không dùng useFromStore để tránh lệch pha)
        ...
        >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: { xs: 1, md: 3 } }}>
            ...
            {ACTION_ICONS.map((item) => {
              ...
              // --- 2. SỬA LỖI Ở ĐÂY: Chỉ hiện Badge khi isMounted = true ---
              // Server (isMounted=false) -> Không hiện Badge -> Khớp với HTML
              // Client (isMounted=true) -> Hiện Badge -> Đúng logic
              if (item.hasBadge && isMounted && badgeCount > 0) {
                iconElement = (
                  <Badge
